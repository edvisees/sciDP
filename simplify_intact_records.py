...
def extract_simple_intact_data(input, title, tsv_output):
    ...
    intact_headings = ['pmid','i_id','orig_fig','fig','type','type_xref','p1_name','p1_xref','p1_site','p2_name','p2_xref','p2_site','p3_name','p3_xref','p3_site','i_meth','i_meth_code','p_meth','p_meth_code']
    intact_rows = []
